...
namespace SharpMap.Data.Providers.Business.MongoDB.Gtfs
{
    public class Route
    {
        ...
        /// field when you are providing data for routes from more than one 
        /// agency.
        /// </summary>
        ...
        /// route serves. 
        /// At least one of route_short_name or route_long_name must 
        /// be specified, or potentially both if appropriate. If the
        /// route does not have a short name, please specify a route_long_name 
        ...
        /// At least one of route_short_name or route_long_name must 
        /// be specified, or potentially both if appropriate. If the 
        /// route does not have a long name, please specify a route_short_name 
        /// and use an empty string as the value for this field.
        /// </summary>
        [BsonElement("route_long_name")]
        public string RouteLongName { get; set; }

        /// <summary>
        /// The route_desc field contains a description of a route. 
        /// Please provide useful, quality information. Do not simply 
        /// duplicate the name of the route. 
        /// For example, "A trains operate between Inwood-207 St, Manhattan and Far Rockaway-Mott Avenue, Queens at all times. 
